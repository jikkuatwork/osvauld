...
export function createCommand(program: Command): void {
  program
    ...
    .action(async (title: string, content: string, options: { folder?: string; tags?: string }) => {
...
export function listCommand(program: Command): void {
  program
    ...
    .action(async (options: { favorites?: boolean }) => {
      try {
        const app = getAuthenticatedApp();
...
export function getCommand(program: Command): void {
  program
    ...
    .action(async (documentId: string, options: { contentOnly?: boolean }) => {
      try {
        const app = getAuthenticatedApp();
...
export function updateCommand(program: Command): void {
  program
    ...
    .action(async (documentId: string, content: string) => {
...
export function deleteCommand(program: Command): void {
  program
    ...
    .action(async (documentId: string, options: { yes?: boolean }) => {
      if (!options.yes) {
 ...
 */
export function favoriteCommand(program: Command): void {
  program
    .command('favorite')
