...
import type { Folder } from '@osvauld/core';

/**
 * Create folder command
 */
export function createFolderCommand(program: Command): void {
  program
    .command('folder')
 ...
 */
export function listFoldersCommand(program: Command): void {
  program
    .command('folders')
 ...
 * Move folder command
 */
export function moveFolderCommand(program: Command): void {
  program
    .command('move-folder')
    ...
    .action(async (folderId: string, options: { parent?: string }) => {
 ...
 */
export function deleteFolderCommand(program: Command): void {
  program
